...
export default function Cubes () {
    return (
        ...
        <div className="card-content">
          ...
          1th Generation 11 Inch 2025, iPad 10th Generation 10.9 inch 2022, Slim Stand Protective Cover with Hard PC Translucent Back Shell Cover, Support Touch ID, Navy Blue<a>@IOS</a>
          <br />
            <br />
            <h4><b>Rating</b></h4>
